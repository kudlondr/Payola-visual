...
class Modal(
    ...
    val cssClass: String = "", resizable: Boolean = false)
    extends ComposedView
{
    ...
    def createSubViews = {
        ...
        if(resizable) {
            modalContent.addCssClass("resizable").setAttribute("style", "overflow: auto; height: 600px; width:900px")
            modalBody.setAttribute("style", "resize: none;")
        }
